function process_y(CSVFile, CSVPath, YFile, YPath)
fprintf("Processing " + CSVFile + " & " + YFile + " ~> READ... ");
...
dlmwrite([char(CSVPath), 'label_', char(FileName), '.csv'], y, 'delimiter', ',', 'precision', 8);
fprintf('OK!\n');
end
